			        ...
			        <div className="location-confirm">
			            <div className="wrapper-location-map-go">
			                ...
			                <div href="" className="location-map-go__container">
			                    <a className="location-map-go__item">
			                    ...
			                    <a href="" className="location-map-go__item">
			                        <div className="img-round">
...
export const MainContainer = connect(mapStateToProps, Object({SetStartPointAddressAction, SetStartPointCoordinatesAction}))(Main);